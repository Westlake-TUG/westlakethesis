...
\LaTeX\ is a document preparation system conducted by
Lamport\cite{lamport1994document}. This package
referred~\parencite{knuth1984texbook, usrguide, clsguide, fntguide} and
constructed under the \CTeX\ kit\cite{ctex}
and~the \textsf{xeCJK} package\cite{xeCJK}.
The \textsf{docstrip} program\cite{mittelbach1994docstrip} is used for
